...
public class InterfacciaUscita {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfacciaUscita window = new InterfacciaUscita();
	...
	private void initialize() {
		...
		frame.setTitle("Interfaccia Uscita");
		frame.move(550, 250);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GestorePresenza.prendiDatiU(textNome.getText(), textCognome.getText(), textMatricola.getText());
			}
		});
